...
El script exige el origen de la API como segundo argumento y valida que sea `https`. Si el
repositorio no esta en `$HOME/vitahub`, indicarlo con `APP_DIR=/ruta/al/repo` delante del
comando.
