...
interface QuoteForm { targetType: 'lead' | 'client'; targetId: string; title: string; currency: string; validUntil: string; notes: string; items: Array<{ _key?: string; serviceId: string; description: string; quantity: string; unitPrice: string }> }
const emptyItem = () => ({ _key: crypto.randomUUID(), serviceId: '', description: '', quantity: '1', unitPrice: '0' });
