...
export function ContactsPage() {
  ...
  <div className="page-header"><div><span className="page-eyebrow">CRM · FASE 1</span><h1>Contactos de reservas</h1><p className="page-subtitle">Las personas que reservaron con cada cliente, con su resultado de asistencia.</p></div></div>
