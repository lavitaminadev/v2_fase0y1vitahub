...
export function KnowledgePage() {
  ...
  return <div className="page knowledge-page">
    <section className="knowledge-hero"><div><span className="page-eyebrow">MEMORIA OPERATIVA</span><h1>Base de conocimiento</h1><p>Consulta políticas, manuales y documentos internos procesados para el equipo. Esta sección no genera campañas ni contenido de marketing.</p></div><div className="knowledge-stats"><span><small>Fuentes</small><strong>{sources.length}</strong></span><span><small>Fragmentos</small><strong>{chunks.length}</strong></span><span><small>Volumen</small><strong>{totalTokens.toLocaleString('es-CL')} <i>tokens</i></strong></span></div></section>
